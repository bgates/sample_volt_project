Volt.configure do |config|
  ...
  #######################################
  config.domain = 'sample-volt-project.com'
  config.app_name = 'Sample_volt_project'
  config.mailer.from = 'Sample_volt_project <no-reply@sample-volt-project.com>'
  ...
  #
  config.app_secret = 'zzvZYBCZ9KuqKs71OrdAEqkmQvpFMmrL-pUFUiWJgRsohSJJIpKGixPLvcTyG6NxKKc'
